...
**Need help?** Open an issue on GitHub or contact the project maintainer, Gayathri Adulla.
...
**Gayathri Adulla**
AI Engineer | Generative AI | LLMs | MLOps

Gayathri is an AI/ML Engineer with over 3 years of experience in developing and deploying machine learning, generative AI, and production-grade AI systems. Her work focuses on building scalable AI infrastructure, including RAG systems and agentic AI, with a particular interest in applying these technologies to cybersecurity and automated SOC environments.
