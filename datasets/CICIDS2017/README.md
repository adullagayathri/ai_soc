...
This repository and its contents are actively maintained by Gayathri Adulla.

Gayathri is an AI Engineer specializing in machine learning, generative AI, and MLOps. With a focus on robust AI systems, Gayathri ensures the continued accuracy, usability, and relevance of this dataset and its associated resources for the intrusion detection community.

- **GitHub**: [adullagayathri](https://github.com/adullagayathri)
- **LinkedIn**: [Gayathri Adulla](https://www.linkedin.com/in/gayathri-adulla-924056216/)
