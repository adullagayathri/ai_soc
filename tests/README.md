...
This framework is maintained by Gayathri Adulla, an AI Engineer specializing in Generative AI, LLMs, and MLOps. With a focus on building robust production AI systems, she oversees the testing infrastructure for the AI-SOC project to ensure high standards of security and performance.
