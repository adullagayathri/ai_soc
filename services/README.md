...
```bash
# Clone repository
git clone https://github.com/adullagayathri/AI_SOC.git
cd AI_SOC/services
...
**Current Maintenance:**
- Gayathri Adulla (gayathri.adulla@outlook.com)
- Original Research: Abdul Bari (CSUSB Cybersecurity Research)
...
Gayathri Adulla is an AI/ML Engineer with over 3 years of experience in developing and deploying production-grade AI systems. Specializing in Generative AI, LLMs, RAG, and MLOps, she focuses on building scalable and secure AI infrastructure. Her expertise includes working with LangChain, FastAPI, and vector databases to create intelligent automation solutions.
