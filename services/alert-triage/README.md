...
For now, development and maintenance is managed by Gayathri Adulla (gayathri.adulla@outlook.com), building upon the initial framework established by Abdul Bari.
...
Gayathri Adulla is an AI Engineer with over 3 years of experience in developing and deploying production AI systems. Her expertise spans Generative AI, LLMs, RAG, and MLOps, with a focus on building scalable infrastructure and intelligent automation for security operations.
